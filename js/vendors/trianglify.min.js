    ...
    return function r(e, f, n) {
        ...
        "/Users/qrohlf/Projects/trianglify/lib/pattern.js": [function(e, r) {
            function f(e, r) {
                function f() {
                    ...
                    return f.setAttribute("width", r.width),
                ...
                function t(f) {
                    return f || (f = n.createElement("canvas")),
        ...
        "/Users/qrohlf/Projects/trianglify/node_modules/chroma-js/chroma.js": [function(r, f, n) {
            (function() {
                ...
                ,
                "undefined" != typeof f && null !== f && null != f.exports && (f.exports = s),
                ...
                s.interpolate = function(e, f, n, t) {
                    return null == e || null == f ? "#000" : ("string" === U(e) && (e = new r(e)),
                ...
                s.contrast = function(e, f) {
                    var n, t;
                    return "string" === U(e) && (e = new r(e)),
                    "string" === U(f) && (f = new r(f)),
                    n = e.luminance(),
                    t = f.luminance(),
                    n > t ? (n + .05) / (t + .05) : (t + .05) / (n + .05)
                }
                ,
                ...
                r = function() {
                    function e() {
                        ...
                        if (0 === f.length)
                            ...
                            "string" === U(f[0]) ? (o = f[0],
                            n = "hex") : "object" === U(f[0]) ? (p = f[0]._rgb,
                            o = p[0],
                            c = p[1],
                            u = p[2],
                            e = p[3],
                            n = "rgb") : f.length >= 3 && (o = f[0],
                            c = f[1],
                            u = f[2]);
                        3 === f.length ? (n = "rgb",
                        e = 1) : 4 === f.length ? "string" === U(f[3]) ? (n = f[3],
                        e = 1) : "number" === U(f[3]) && (n = "rgb",
                        e = f[3]) : 5 === f.length && (e = f[3],
                        n = f[4]),
                        null == e && (e = 1),
                        "rgb" === n ? t._rgb = [o, c, u, e] : "gl" === n ? t._rgb = [255 * o, 255 * c, 255 * u, e] : "hsl" === n ? (t._rgb = v(o, c, u),
                        t._rgb[3] = e) : "hsv" === n ? (t._rgb = w(o, c, u),
                        t._rgb[3] = e) : "hex" === n ? t._rgb = m(o) : "lab" === n ? (t._rgb = k(o, c, u),
                        t._rgb[3] = e) : "lch" === n ? (t._rgb = j(o, c, u),
                        t._rgb[3] = e) : "hsi" === n && (t._rgb = y(o, c, u),
                        t._rgb[3] = e),
                        a = b(t._rgb)
                    }
                    ...
                    e.prototype.luminance = function(r, f) {
                        ...
                        o = function(e, n) {
                            var c, u;
                            return u = e.interpolate(.5, n, f),
                            c = u.luminance(),
                            Math.abs(r - c) < t || !a-- ? u : c > r ? o(e, u) : o(u, n)
                        }
                        ,
                        this._rgb = (n > r ? o(new e("black"), this) : o(this, new e("white"))).rgba(),
                        this) : P(this._rgb)
                    }
                    ,
                    ...
                    e.prototype.css = function(e) {
                        ...
                        "rgb" === e ? e + "(" + n.slice(0, 3).map(Math.round).join(",") + ")" : "rgba" === e ? e + "(" + n.slice(0, 3).map(Math.round).join(",") + "," + n[3] + ")" : "hsl" === e || "hsla" === e ? (r = f.hsl(),
                        t = function(e) {
                    ...
                    e.prototype.interpolate = function(r, f, n) {
                        ...
                        "hsl" === n || "hsv" === n || "lch" === n || "hsi" === n)
                            "hsl" === n ? (p = d.hsl(),
                            m = f.hsl()) : "hsv" === n ? (p = d.hsv(),
                            m = f.hsv()) : "hsi" === n ? (p = d.hsi(),
                            m = f.hsi()) : "lch" === n && (p = d.lch(),
                            m = f.lch()),
                            "h" === n.substr(0, 1) ? (o = p[0],
                            h = p[1],
                            l = p[2],
                            c = m[0],
                            g = m[1],
                            ...
                            g = m[1],
                            c = m[2]),
                            isNaN(o) || isNaN(c) ? isNaN(o) ? isNaN(c) ? a = Number.NaN : (a = c,
                            1 !== l && 0 !== l || "hsv" === n || (b = g)) : (a = o,
                            1 !== i && 0 !== i || "hsv" === n || (b = h)) : (t = c > o && c - o > 180 ? c - (o + 360) : o > c && o - c > 180 ? c + 360 - o : c - o,
                            a = o + r * t),
                            null == b && (b = h + r * (g - h)),
                            u = l + r * (i - l),
                            s = "h" === n.substr(0, 1) ? new e(a,b,u,n) : new e(u,b,a,n);
                        else if ("rgb" === n)
                            p = d._rgb,
                            m = f._rgb,
                            s = new e(p[0] + r * (m[0] - p[0]),p[1] + r * (m[1] - p[1]),p[2] + r * (m[2] - p[2]),n);
                        else {
                            if ("lab" !== n)
                        ...
                        return s.alpha(d.alpha() + r * (f.alpha() - d.alpha())),
                        s
                    }
                    ,
                ...
                p = function(e) {
                    ...
                    if (n = e.match(/rgb\(\s*(\-?\d+),\s*(\-?\d+)\s*,\s*(\-?\d+)\s*\)/)) {
                        ...
                        (n = e.match(/hsl\(\s*(\-?\d+(?:\.\d+)?),\s*(\-?\d+(?:\.\d+)?)%\s*,\s*(\-?\d+(?:\.\d+)?)%\s*\)/)) ? (r = n.slice(1, 4),
                        r[1] *= .01,
                        r[2] *= .01,
                        t = v(r),
                        t[3] = 1) : (n = e.match(/hsla\(\s*(\-?\d+(?:\.\d+)?),\s*(\-?\d+(?:\.\d+)?)%\s*,\s*(\-?\d+(?:\.\d+)?)%\s*,\s*([01]|[01]?\.\d+)\)/)) && (r = n.slice(1, 4),
                        r[1] *= .01,
                        r[2] *= .01,
                        t = v(r),
                        t[3] = +n[4]);
                ...
                v = function() {
                    ...
                    0 === c)
                        ...
                        t = d = 0; 2 >= d; t = ++d)
                            i[t] < 0 && (i[t] += 1),
                            i[t] > 1 && (i[t] -= 1),
                            r[t] = 6 * i[t] < 1 ? u + 6 * (l - u) * i[t] : 2 * i[t] < 1 ? l : 3 * i[t] < 2 ? u + (l - u) * (2 / 3 - i[t]) * 6 : u;
                ...
                k = function(e, r, f) {
                    var n, t, a, o, i, d, s;
                    return void 0 !== e && 3 === e.length && (d = e,
                    e = d[0],
                    r = d[1],
                    f = d[2]),
                    void 0 !== e && 3 === e.length && (s = e,
                    e = s[0],
                    r = s[1],
                    f = s[2]),
                    o = (e + 16) / 116,
                    ...
                    o = x(o) * u,
                    i = x(i) * l,
                    t = T(3.2404542 * a - 1.5371385 * o - .4985314 * i),
                    n = T(-.969266 * a + 1.8760108 * o + .041556 * i),
                    f = T(.0556434 * a - .2040259 * o + 1.0572252 * i),
                ...
                B = function(e, r, f) {
                    var n, t, a, o, c, u;
                    return void 0 !== e && e.length >= 3 && (u = e,
                    e = u[0],
                    r = u[1],
                    f = u[2]),
                    e /= 255,
                    ...
                    t = (a + o) / 2,
                    a === o ? (c = 0,
                    n = Number.NaN) : c = .5 > t ? (a - o) / (a + o) : (a - o) / (2 - a - o),
                    e === a ? n = (r - f) / (a - o) : r === a ? n = 2 + (f - e) / (a - o) : f === a && (n = 4 + (e - r) / (a - o)),
                    n *= 60,
                    0 > n && (n += 360),
                    [n, c, t]
                }
                ...
                E = function() {
                    ...
                    r = S(r),
                    e = S(e),
                    n = Y((.4124564 * f + .3575761 * r + .1804375 * e) / c),
                    t = Y((.2126729 * f + .7151522 * r + .072175 * e) / u),
                    a = Y((.0193339 * f + .119192 * r + .9503041 * e) / l),
                ...
                s.scale = function(e, r) {
                    ...
                    c = function(e, r) {
                        var f, n, t, a, c, u, l;
                        if (null == e && (e = ["#ddd", "#222"]),
                        null != e && "string" === U(e) && null != (null != (c = s.brewer) ? c[e] : void 0) && (e = s.brewer[e]),
                        "array" === U(e)) {
                            for (e = e.slice(0),
                            f = t = 0,
                            u = e.length - 1; u >= 0 ? u >= t : t >= u; f = u >= 0 ? ++t : --t)
                                n = e[f],
                                "string" === U(n) && (e[f] = s(n));
                            if (null != r)
                                k = r;
                                ...
                                for (k = [],
                                f = a = 0,
                                l = e.length - 1; l >= 0 ? l >= a : a >= l; f = l >= 0 ? ++a : --a)
                                    k.push(f / (e.length - 1))
                        }
                        return o(),
                        d = e
                    ...
                    f = function(e) {
                        var r, f, n, a, o;
                        return o = e,
                        h.length > 2 && (a = h.length - 1,
                        r = t(e),
                        n = h[0] + (h[1] - h[0]) * (0 + .5 * x),
                        f = h[a - 1] + (h[a] - h[a - 1]) * (1 - .5 * x),
                        o = m + (h[r] + .5 * (h[r + 1] - h[r]) - n) / (f - n) * (p - m)),
                        o
                    }
                    ,
                    a = function(e, r) {
                        ...
                        isNaN(e))
                            return v;
                        if (r ? b = e : h.length > 2 ? (f = t(e),
                        b = f / (w - 1)) : (b = a = m !== p ? (e - m) / (p - m) : 0,
                        b = a = (e - m) / (p - m),
                        ...
                        i[c])
                            ...
                            if ("array" === U(d))
                                for (o = g = 0,
                                _ = k.length - 1; _ >= 0 ? _ >= g : g >= _; o = _ >= 0 ? ++g : --g) {
                                    if (u = k[o],
                                    u >= b) {
                                        n = d[o];
                                        break
                    ...
                    n.domain = function(e, r, f, t) {
                        var a;
                        return null == f && (f = "e"),
                        arguments.length ? (null != r && (a = s.analyze(e, t),
                    ...
                    n.colors = function(r) {
                        ...
                        h.length > 2)
                            for (f = a = 1,
                            u = h.length; u >= 1 ? u > a : a > u; f = u >= 1 ? ++a : --a)
                                t.push(.5 * (h[f - 1] + h[f]));
                        else
                            t = h;
                        for (o = 0,
                ...
                s.analyze = function(e, r, f) {
                    ...
                    n = function(e) {
                        null == e || isNaN(e) || (a.values.push(e),
                        a.sum += e,
                        e < a.min && (a.min = e),
                        e > a.max && (a.max = e),
                        a.count += 1)
                ...
                s.limits = function(e, r, f) {
                    ...
                    "e" === r.substr(0, 1)) {
                        ...
                        for (b.push(p),
                        l = I = 1,
                        Z = f - 1; Z >= 1 ? Z >= I : I >= Z; l = Z >= 1 ? ++I : --I)
                            k = A.length * l / f,
                            x = Math.floor(k),
                            x === k ? b.push(A[x]) : (M = k - x,
                            b.push(A[x] * M + A[x + 1] * (1 - M)));
                        b.push(h)
                        ...
                        a.push(p),
                        l = E = 1,
                        H = f - 1; H >= 1 ? H >= E : E >= H; l = H >= 1 ? ++E : --E)
                            a.push(p + l / f * (h - p));
                        for (a.push(h); j; ) {
                            for (i = R = 0,
                            J = f - 1; J >= 0 ? J >= R : R >= J; i = J >= 0 ? ++R : --R)
                                c[i] = 0;
                            for (l = S = 0,
                            K = v - 1; K >= 0 ? K >= S : S >= K; l = K >= 0 ? ++S : --S) {
                                for (q = A[l],
                                y = Number.MAX_VALUE,
                                i = O = 0,
                                Q = f - 1; Q >= 0 ? Q >= O : O >= Q; i = Q >= 0 ? ++O : --O)
                                    u = Math.abs(a[i] - q),
                                    y > u && (y = u,
                                    t = i);
                                c[t]++,
                            ...
                            for (_ = new Array(f),
                            i = z = 0,
                            er = f - 1; er >= 0 ? er >= z : z >= er; i = er >= 0 ? ++z : --z)
                                _[i] = null ;
                            for (l = Y = 0,
                            rr = v - 1; rr >= 0 ? rr >= Y : Y >= rr; l = rr >= 0 ? ++Y : --Y)
                                o = n[l],
                                null === _[o] ? _[o] = A[l] : _[o] += A[l];
                            for (i = T = 0,
                            L = f - 1; L >= 0 ? L >= T : T >= L; i = L >= 0 ? ++T : --T)
                                _[i] *= 1 / c[i];
                            for (j = !1,
                            i = fr = 0,
                            F = f - 1; F >= 0 ? F >= fr : fr >= F; i = F >= 0 ? ++fr : --fr)
                                if (_[i] !== a[l]) {
                                    j = !0;
                                    break
                                }
                        ...
                        for (d = {},
                        i = nr = 0,
                        V = f - 1; V >= 0 ? V >= nr : nr >= V; i = V >= 0 ? ++nr : --nr)
                            d[i] = [];
                        for (l = tr = 0,
                        D = v - 1; D >= 0 ? D >= tr : tr >= D; l = D >= 0 ? ++tr : --tr)
                            o = n[l],
                            d[o].push(A[l]);
                        for (P = [],
                        i = ar = 0,
                        X = f - 1; X >= 0 ? X >= ar : ar >= X; i = X >= 0 ? ++ar : --ar)
                            P.push(d[i][0]),
                            P.push(d[i][d[i].length - 1]);
                        for (P = P.sort(function(e, r) {
                            return e - r
                        }),
                        b.push(P[0]),
                        l = or = 1,
                        W = P.length - 1; W >= or; l = or += 2)
                ...
                U = function() {
                    ...
                    return function(r) {
                        var f;
                        return f = Object.prototype.toString.call(r),
                        e[f] || "object"
                    }
                }(),
                N = function(e, r, f) {
            ...
            !function() {
                ...
                f = {
                    triangulate: function(r, f) {
                        ...
                        d = [],
                        s = [],
                        o = u.length; o--; s.length = 0) {
                            for (m = u[o],
                            c = i.length; c--; )
                                b = r[m][0] - i[c].x,
                                b > 0 && b * b > i[c].r ? (d.push(i[c]),
                                i.splice(c, 1)) : (h = r[m][1] - i[c].y,
                                b * b + h * h - i[c].r > a || (s.push(i[c].i, i[c].j, i[c].j, i[c].k, i[c].k, i[c].i),
                                i.splice(c, 1)));
                            for (t(s),
                            c = s.length; c; )
                                p = s[--c],
            ...
            !function(e, f, n, t, a, o, c, u, l) {
                function i(e) {
                    ...
                    for (f || (e = [f++]); t > a; )
                        c[a] = a++;
                    for (a = 0; t > a; a++)
                        c[a] = c[o = w & o + e[a % f] + (r = c[a])],
                        c[o] = r;
                    (n.g = function(e) {
                        for (var r, f = 0, a = n.i, o = n.j, c = n.S; e--; )
                            r = c[a = w & a + 1],
                            f = f * t + c[w & (c[a] = c[o = w & o + r]) + (c[o] = r)];
                        return n.i = a,
                        n.j = o,
                        f
                    }
                ...
                function h(r) {
                    try {
                        return p ? g(p.randomBytes(t)) : (e.crypto.getRandomValues(r = new Uint8Array(t)),
                        g(r))
                    } catch (n) {
